...
echo "SEED=$SEED MODEL_NAME=vae PRIOR=vampflowprior NUMBER_COMPONENTS=$VAMPFLOW_K FLOW_HIDDEN_DIM=$FLOW_H FLOW_LAYERS=$FLOW_D WEIGHTED=True bash shellscripts/run_env_experiments.sh" >> $COMMANDS_FILE
